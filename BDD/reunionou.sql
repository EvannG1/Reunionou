...
--
-- Hôte : localhost
-- Généré le : lun. 22 mars 2021 à 11:36
...
--
ALTER TABLE `events`
  ADD CONSTRAINT `FK_location` FOREIGN KEY (`id_loc`) REFERENCES `location` (`id_location`);
COMMIT;
